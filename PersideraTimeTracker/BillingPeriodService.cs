...
namespace PersideraTimeTracker
{
    ...
    public static class BillingPeriodService
    {
        ...
        /// [start, end] period.
        /// </summary>
        public static List<TimeTrackerData> GetEntriesForPeriod(
            IEnumerable<TimeTrackerData> entries, DateTime start, DateTime end)
        {
            return entries
                .Where(e =>
                {
                    DateTime local = e.StartTime.LocalDateTime;
